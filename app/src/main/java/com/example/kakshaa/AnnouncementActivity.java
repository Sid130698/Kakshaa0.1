...
public class AnnouncementActivity extends AppCompatActivity {
    EditText announcementTextEditText,titleEditText;
    String announcementString,announcementTitle;
        ...
        databaseReference.child("students").child(currentUserId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    username="Teacher";
                    databaseReference.child("Teacher").child(currentUserId).addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            if(dataSnapshot.exists()){
                                username=dataSnapshot.child("teacherName").getValue().toString();
                                progressDialog.dismiss();
                            }
                        }
    ...
    private void IntializeFields() {
        ...
        titleEditText=findViewById(R.id.announcementTitleEditText);
    ...
    public void postThisAnnouncement(View view) {
        ...
        try{
            announcementTitle=titleEditText.getText().toString();
            ...
            if(announcementString.isEmpty()){
                ...
                if(username==null)
                {
                    ...
                    announcementHashMap.put("Title",announcementTitle);
