...
public class requestAdapter extends FirebaseRecyclerAdapter<com.example.kakshaa.requestModelClass,requestAdapter.requestViewHolder> {
     ...
     * @param options
     */
    public requestAdapter(@NonNull FirebaseRecyclerOptions<com.example.kakshaa.requestModelClass> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull requestViewHolder holder, int position, @NonNull com.example.kakshaa.requestModelClass model) {
