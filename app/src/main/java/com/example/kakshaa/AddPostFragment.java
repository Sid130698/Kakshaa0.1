...
public class AddPostFragment extends Fragment {
    Button addAnnouncementButton,addAssignmentButton;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        orTextView=view.findViewById(R.id.orInAddPost);
        addAnnouncementButton=view.findViewById(R.id.addAnnouncementButton);
                        ...
                        if (!userId.isEmpty()) {
                            ...
                            addAssignmentButton.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    startActivity(new Intent(getActivity(),selectSubjectForAssignmentActivity.class));
